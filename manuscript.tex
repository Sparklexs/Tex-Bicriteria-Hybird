...
While a single encoder yields a relatively stable point in the space-time trade-off curve, flexibly transforming its characteristic along the curve to fit different IR tasks can be a better way to prepare the index.
