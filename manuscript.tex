...
Given the fact that each posting list is divided into fixed-sized blocks (say, 128 postings) and a set of $ k $ encoders, the algorithm finishes in $ \Theta(nk\log(nk)) $ time and $ O(nk) $ space.
...
\bibliography{sigproc,reference}  % sigproc.bib is the name of the Bibliography in this case
